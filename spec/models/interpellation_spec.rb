...
describe Interpellation do
  ...
  it "#ivod_update_vod_work" do
    ...
    interpellation = FactoryGirl.build :interpellation
  ...
  it "order created_at desc work" do
    interpellation1 = FactoryGirl.create(:interpellation, created_at: 1.day.ago)
    interpellation2 = FactoryGirl.create(:interpellation, created_at: Time.now)
  ...
  it "published work" do
    ...
    interpellation2 = FactoryGirl.create(:interpellation, published: false)
    expect(Interpellation.published).to eq([interpellation1])
  end

  it "created_in_time_count created_after work" do
    interpellation1 = FactoryGirl.create(:interpellation, created_at: Time.now)
    interpellation2 = FactoryGirl.create(:interpellation, created_at: 2.month.ago)
    interpellation3 = FactoryGirl.create(:interpellation, created_at: 4.months.ago)
  ...
  it "validate is_source_url work" do
    ...
    interpellation.save
    expect(interpellation.errors.messages[:base].first).to eq('ivod網址出錯')
